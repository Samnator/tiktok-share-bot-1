...
class TikTok:
    def __init__(self):
        ...
        print(Colorate.Horizontal(Colors.yellow_to_red, "      TIKTOK SHARE BOT BY Kirito-IA#0001", 1))
        print(Colorate.Horizontal(Colors.yellow_to_red, "         ♥ Share bot for tiktok ♥", 1))
        print(Colorate.Horizontal(Colors.yellow_to_red, "   ! IT MIGHT TAKE UP TO 24 HOURS TO SHOW !", 1))
    ...
    def close(self, message):
        print(f'\n{message}')
        os.system("title Scripting's TikTok SharesBot - Restart required")
        os.system('pause >NUL')
        os.system("title Scripting's TikTok SharesBot - Closing...")
        sleep(3)
        os._exit(0)
